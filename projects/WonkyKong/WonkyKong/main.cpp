...
const string assetDirectory = "/Users/lkross/Desktop/CS32/projects/WonkyKong/DerivedData/WonkyKong/Build/Products/Debug/Assets";
...
int main(int argc, char* argv[])
{
    ...
    // fixed by running "echo $DISPLAY" in terminal
    setenv("DISPLAY", "/private/tmp/com.apple.launchd.P3ZSKDGxQo/org.xquartz:0", 1);
